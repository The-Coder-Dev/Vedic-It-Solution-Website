            ...
            <section className="w-full mx-auto max-w-345 flex flex-col items-start justify-between py-15 px-8 absolute inset-0 z-3">
                <div className="w-full h-full flex flex-col gap-6 justify-between">
                    <div className="flex flex-col gap-4">
                        ...
                        <h1 className="text-secondary text-4xl md:text-5xl font-semibold">
                            Let's create something
                            <br /><span className="font-[dm_serif] text-white italic">Remarkable together.</span>
                        </h1>
                        <p className="text-secondary max-w-lg">
                            Helping brands grow through strategy, creativity, and technology.
                        </p>
                    ...
                    <div className="w-full flex flex-col md:flex-row gap-4 items-start justify-between">
                        <Button asChild  className="text-secondary hover:text-white text-2xl md:text-4xl" variant='link'>
